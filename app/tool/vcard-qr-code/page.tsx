...
export const metadata = { title: "vCard QR Code Generator — vCard Editor", description: "Generate a QR code locally from a vCard contact.", alternates: { canonical: "/tool/vcard-qr-code" } };
