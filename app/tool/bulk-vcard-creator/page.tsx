...
export const metadata = { title: "Bulk vCard Creator — vCard Editor", description: "Create multiple vCards from a CSV or TSV locally in your browser.", alternates: { canonical: "/tool/bulk-vcard-creator" } };
