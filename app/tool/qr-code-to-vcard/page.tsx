...
export const metadata = { title: "QR Code to vCard — vCard Editor", description: "Decode a selected QR image locally and export a vCard when it contains one.", alternates: { canonical: "/tool/qr-code-to-vcard" } };
