...
export const metadata = toolPageMetadata({ title: "VCF to Excel — vCard Editor", description: "Convert VCF contacts to an Excel workbook locally in your browser.", path: "/tool/vcf-to-excel" });
