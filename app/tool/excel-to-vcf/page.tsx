...
export const metadata = { title: "Excel to VCF — vCard Editor", description: "Map an Excel contact sheet to a VCF file locally in your browser.", alternates: { canonical: "/tool/excel-to-vcf" } };
