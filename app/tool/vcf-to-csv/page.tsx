...
export const metadata = { title: "VCF to CSV — vCard Editor", description: "Convert a VCF contact file to CSV locally in your browser.", alternates: { canonical: "/tool/vcf-to-csv" } };
