...
export const metadata = { title: "Normalize phone numbers — vCard Editor", description: "Standardize phone-number formatting with an explicit country-code rule.", alternates: { canonical: "/tool/normalize-phone-numbers" } };
