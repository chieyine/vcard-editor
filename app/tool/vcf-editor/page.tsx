...
export const metadata = toolPageMetadata({ title: "VCF Editor — vCard Editor", description: "Open, edit, and export a VCF contact file locally in your browser.", path: "/tool/vcf-editor" });
