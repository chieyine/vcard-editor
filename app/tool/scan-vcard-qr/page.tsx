...
export const metadata = toolPageMetadata({ title: "Scan a vCard QR — vCard Editor", description: "Scan a vCard QR code with explicit camera permission when your browser supports local detection.", path: "/tool/scan-vcard-qr" });
