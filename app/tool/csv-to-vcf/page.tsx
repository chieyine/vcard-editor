...
export const metadata = { title: "CSV to VCF — vCard Editor", description: "Map CSV columns to contact fields and create a VCF file locally.", alternates: { canonical: "/tool/csv-to-vcf" } };
