...
export default function Home() {
  return (
    <main>
      ...
      <section className="jobs-section" id="popular" aria-labeledby="jobs-heading">
      ...
      <section className="home-categories" aria-labeledby="categories-heading">
